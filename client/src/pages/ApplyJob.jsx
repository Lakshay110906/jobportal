        ...
        <div className='bg-white text-black rounded-lg w-full'>
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start'>
            <div className='w-full lg:w-2/3'>
              ...
              <button onClick={()=>applyHandler()} className='bg-blue-600 p-2.5 px-10 cursor-pointer text-white rounded mt-10'>{isAlreadyApplied ? 'Already Applied' : "Apply Now"}</button>
            </div>
            {/* /* {right section }  */}
